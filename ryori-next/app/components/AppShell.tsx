...
const navItems: NavItem[] = [
	...
	{ href: '/menu', label: 'Menu', icon: <span aria-hidden="true" className="ico ico--menu"></span> },
	{ href: '/inventory', label: 'Inventory', icon: <span aria-hidden="true" className="ico ico--list"></span> },
	{ href: '/employees', label: 'Employees', icon: <span aria-hidden="true" className="ico ico--user"></span> },
	{ href: '/reviews', label: 'Reviews', icon: <span aria-hidden="true" className="ico ico--star"></span> },
	...
	{ href: '/settings', label: 'Settings', icon: <span aria-hidden="true" className="ico ico--settings"></span> }
];
		...
		<>
			...
			<div className={`dash-shell ${isSidebarExpanded ? 'is-expanded' : 'is-collapsed'}`}>
				...
				<nav className="dash-bottomnav" aria-label="Bottom">
					...
					<Link href="/menu" className="bottom-link">
						<span aria-hidden="true" className="ico ico--menu"></span>
						<span className="bottom-text">Menu</span>
					</Link>
					<Link href="/settings" className="bottom-link">
